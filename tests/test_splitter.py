...
from PyDecisionTree.splitter import WeightedLoss, InformationGain
...
class TestWeightedEntropy(unittest.TestCase):
    """
    Tests the class WeightedEntropy.
    """
    ...
    def setUp(self):
        ...
        self.splitter = WeightedLoss(criteria=Entropy())
    ...
    def test_call(self):
        ...
        """
        value = self.splitter(self.X, self.y, self.X_left, self.y_left, self.X_right, self.y_right)
        np.testing.assert_array_almost_equal(0.46209812037329684, value)
